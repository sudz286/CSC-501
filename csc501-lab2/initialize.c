...
bs_map_t bsm_tab[8];
// Page Directory mapping init
fr_map_t frm_tab[NFRAMES];

policy_sc sc_frames[NFRAMES];
policy_aging aging_frames[NFRAMES];
int qhead_sc=-1;
int qhead_aging=-1;
...
*/
	...
	*( (int *)pptr->pbase ) = MAGIC;
	...
	pd_tab=(1024+frame_id)*NBPG;
	proctab[NULLPROC].pdbr=(1024+frame_id)*NBPG;
